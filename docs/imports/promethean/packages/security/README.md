...
```typescript
import { validatePath, PathSecurityConfig } from '@promethean-os/security';
...
```typescript
import { sanitizeFileName, createSecurePath } from '@promethean-os/security';
...
```typescript
import { isCrossPlatformSafe } from '@promethean-os/security';
